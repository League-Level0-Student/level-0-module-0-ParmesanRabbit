...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// or a kick
			String AttackMethod = JOptionPane.showInputDialog("Will you attack the dragon with a yell or a kick?");
			...
			// round)
			JOptionPane.showMessageDialog(null, "You lost " + dragonAttack + " health points. The dragon lost "
					+ playerAttack + "\n" + "health points.");
	...
	static void dragonLost() {
		...
		// gold!
		JOptionPane.showMessageDialog(null, "You have defeated the dragon! You are rich now.");
		System.exit(0); // This code ends the program
	}
